...
// Retrieve the requested map from URL parameters
const urlParams = new URLSearchParams(window.location.search);
const requestedMap = urlParams.get('map') || 'spawn_map';
let map;
if (maps[requestedMap]) {
    map = maps[requestedMap];
} else {
    console.error(JSON.stringify({ error: "Map not found" }));
}
